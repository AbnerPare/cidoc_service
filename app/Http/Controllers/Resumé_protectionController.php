...
use App\Models\Resumé_protection;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class Resumé_protectionController extends Controller {

    public function protection() {
        $users = Resumé_protection::query()->latest()->paginate( 10 );
